...
// Comprehensive problems data (representing your 294 problems)
const allProblems = [
  // Array Problems
  {
    title: "Two Sum",
...
async function main() {
  ...
  switch (command) {
    ...
    default:
      console.log('🔄 Simple Problem Sync Tool');
      console.log('\nUsage:');
      console.log('  node simple-sync.js populate  - Populate backend with all problems');
      console.log('  node simple-sync.js count    - Check current problem count');
      console.log('\nExamples:');
      console.log('  node simple-sync.js populate');
      console.log('  node simple-sync.js count');
  }
}
